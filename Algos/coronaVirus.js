...
//   function coronaVirusAtRisk(people) {}
   ...
   * - Space: O(n) linear.
   */
  const functionalCoronaVirusAtRisk = (persons) => persons.filter((person) =>
      person.isSocialDistancing === false && person.friends.findIndex((friend) => friend.isSocialDistancing === false && friend.hasCovid) > -1)
